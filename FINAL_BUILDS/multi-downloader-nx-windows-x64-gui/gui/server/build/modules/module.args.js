...
exports.availableFilenameVars = exports.groups = exports.args = exports.buildDefault = exports.getDefault = exports.muxer = void 0;
var module_langsData_1 = require("./module.langsData");
...
var availableFilenameVars = ['title', 'episode', 'showTitle', 'seriesTitle', 'season', 'width', 'height', 'service'];
exports.availableFilenameVars = availableFilenameVars;
exports.muxer = ['ffmpeg', 'mkvmerge'];
var args = [
    {
        name: 'absolute',
    ...
    },
    {
        ...
        group: 'search',
        choices: __spreadArray([], __read(module_langsData_1.searchLocales.filter(function (a) { return a !== undefined; })), false),
        default: {
            default: 'en-US'
        },
        type: 'string',
    ...
    },
    {
        ...
        choices: __spreadArray(__spreadArray([], __read(Object.keys(enums_1.CrunchyVideoPlayStreams)), false), ['none'], false),
        docDescribe: true,
        usage: '${device}'
    },
    {
    ...
    },
    {
        ...
        choices: __spreadArray(__spreadArray([], __read(Object.keys(enums_1.CrunchyAudioPlayStreams)), false), ['none'], false),
        default: {
            default: 'android'
        },
        docDescribe: true,
    ...
    },
    {
        ...
        choices: module_langsData_1.subtitleLanguagesFilter.slice(1),
        default: {
            default: 'none'
        },
        type: 'string',
    ...
    },
    {
        ...
        describe: 'Download subtitles by language tag (space-separated)' +
            "\nCrunchy Only: ".concat(module_langsData_1.languages
                .filter(function (a) { return a.cr_locale; })
                .map(function (a) { return a.locale; })
                .join(', ')),
        docDescribe: true,
        service: ['all'],
        type: 'array',
        choices: module_langsData_1.subtitleLanguagesFilter,
        default: {
            default: ['all']
        },
        usage: '${sub1} ${sub2}'
    ...
    },
    {
        ...
        docDescribe: true,
        group: 'dl',
        choices: module_langsData_1.dubLanguageCodes,
        default: {
            default: [module_langsData_1.dubLanguageCodes.slice(-1)[0]]
        },
        service: ['all'],
        type: 'array',
        usage: '${dub1} ${dub2}'
    ...
    },
    {
        ...
        describe: "Set how long a number in the title should be at least.\n".concat([
            ...
            .map(function (val) { return "Set in config: ".concat(val[0], "; Episode number: ").concat(val[1], "; Output: ").concat(val[2]); })
            .join('\n')),
        type: 'number',
        default: {
            default: 2
    ...
    {
        name: 'defaultAudio',
        describe: "Set the default audio track by language code\nPossible Values: ".concat(module_langsData_1.languages.map(function (a) { return a.code; }).join(', ')),
        docDescribe: true,
        group: 'mux',
        service: ['all'],
        type: 'string',
        ...
        transformer: function (val) {
            var item = module_langsData_1.languages.find(function (a) { return a.code === val; });
            if (!item) {
                throw new Error("Unable to find language code ".concat(val, "!"));
            }
            return item;
        }
    },
...
exports.args = args;
var getDefault = function (name, cfg) {
    var _a, _b;
    var option = args.find(function (item) { return item.name === name; });
    if (!option)
        throw new Error("Unable to find option ".concat(name));
    if (option.default === undefined)
        throw new Error("Option ".concat(name, " has no default"));
    if (typeof option.default === 'object') {
        if (Array.isArray(option.default))
            return option.default;
        if (Object.prototype.hasOwnProperty.call(cfg, (_a = option.default.name) !== null && _a !== void 0 ? _a : option.name)) {
            return cfg[(_b = option.default.name) !== null && _b !== void 0 ? _b : option.name];
        }
        else {
...
var buildDefault = function () {
    var data = {};
    var defaultArgs = args.filter(function (a) { return a.default; });
    defaultArgs.forEach(function (item) {
        var _a;
        if (typeof item.default === 'object') {
            if (Array.isArray(item.default)) {
                ...
                data[(_a = item.default.name) !== null && _a !== void 0 ? _a : item.name] = item.default.default;
            }
        }
        else {
            data[item.name] = item.default;
